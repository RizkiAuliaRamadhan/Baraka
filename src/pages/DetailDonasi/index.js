      ...
      <View style={styles.container}>
        ...
        <View style={styles.cardContent1}>
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Image source={B} style={styles.image1} alt="gambar" />
              <View style={{marginLeft: 10, justifyContent: 'center'}}>
                <Text style={styles.text6}>{data.penggalangDana}</Text>
        ...
        <View style={styles.cardContent1}>
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Image source={Shield} style={styles.image1} alt="gambar" />
              <View style={{marginLeft: 10, justifyContent: 'center'}}>
                <Text style={styles.text6}>{data.penyalurDana}</Text>
                <Text style={styles.text7}>{data.akunPenyalurDana}</Text>
              </View>
            </View>
            <Centang />
          </View>
